...
_G.packer_plugins = {
  ["ChatGPT.nvim"] = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/ChatGPT.nvim",
  ...
  ["nui.nvim"] = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/nui.nvim",
  ...
  ["oil.nvim"] = {
    ...
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/oil.nvim",
  ...
  rustaceanvim = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/rustaceanvim",
